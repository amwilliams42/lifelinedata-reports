...
<script>
	import DateInput from './_CustomDateInput.svelte';
	// import { Query } from '@evidence-dev/sdk/usql';
	import { getLocalTimeZone } from '@internationalized/date';
	import HiddenInPrint from '@evidence-dev/core-components/dist/atoms/inputs/shared/HiddenInPrint.svelte';
	import { page } from '$app/stores';
	import QueryLoad from '@evidence-dev/core-components/dist/atoms/query-load/QueryLoad.svelte';
	import { Skeleton } from '@evidence-dev/core-components/dist/atoms/skeletons/index.js';
	import { getInputContext } from '@evidence-dev/sdk/utils/svelte';
	import { toBoolean } from './utils.js';
	import { dateToYYYYMMDD, formatDateString } from './helpers.js';
	import { buildQuery } from '@evidence-dev/component-utilities/buildQuery';
	import InlineError from '@evidence-dev/core-components/dist/atoms/inputs/InlineError.svelte';
	import checkRequiredProps from '@evidence-dev/core-components/dist/atoms/inputs/checkRequiredProps.js';
